...
export default function AddProductModal() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            if (formData.image) {
                const imageUploadRes = await uploadImage(formData.image);
                if (imageUploadRes.success) {
                    setFormData({ ...formData, image: imageUploadRes.url as any });
                    const info = { ...formData, image: imageUploadRes.url as any };
